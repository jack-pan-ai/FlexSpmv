...
def flex_spmv_op(spm_k, spm_l, row_offsets, col_indices_i, col_indices_j, vector_x, vector_y):
    """
    ...
    Args:
        ...
        vector_y (torch.Tensor): Output vector for storing forces
        
    Returns:
        torch.Tensor: Output vector containing the forces on each point
    """
    return flex_spmv.flex_spmv(spm_k, spm_l, row_offsets, col_indices_i, col_indices_j, vector_x, vector_y)
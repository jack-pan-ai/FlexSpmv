    ...
    CoordinateT&    path_coordinate)
{
    ...
    OffsetT split_min = cub::CUB_MAX(diagonal - b_len, 0);
    OffsetT split_max = cub::CUB_MIN(diagonal, a_len);
    ...
    path_coordinate.x = cub::CUB_MIN(split_min, a_len);

...
#  -------------------------------------------------------------
    ...
    input_parameters_code, input_agent_tenosrs_code, output_agent_tenosrs_code, output_agent_forloop_code, selector_code = declarations_gen(inputs, outputs, selector_register, reducer_operations, aggregator_operations)
    ...
    reducer_consume_init_code, reducer_consume_forloop_code, reducer_consume_forloop_add_code, reducer_partial_init_code, reducer_partial_forloop_code, reducer_partial_carry_code, reducer_partial_carry_fixup_code = reducer_gen(reducer_operations)
